import svgPaths from "./svg-30t332qk80";
...
function Container2() {
  return (
    <div className="absolute bg-gradient-to-r box-border content-stretch flex flex-col from-[#e73a40] h-[123.942px] items-start left-0 pb-0 pt-[23.994px] px-[23.994px] rounded-bl-[24px] rounded-br-[24px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] to-[#e7000b] top-0 w-[393.412px]" data-name="Container">
      <Container1 />
    </div>
  );
}
